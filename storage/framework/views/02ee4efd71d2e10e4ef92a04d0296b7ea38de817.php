            ...
            <div class="row">
                <div class="sf-contener clearfix col-lg-12" id="block_top_menu">
                    ...
                    <ul class="sf-menu clearfix menu-content">
                        ...
                        <li>
                            <a class="navbar-brand" href="<?php echo e(URL_HOME_AUCTIONS); ?>">
                              <img class="img-fluid" src="<?php echo e(IMAGE_PATH_SETTINGS.getSetting('site_logo', 'site_settings')); ?>" alt="Auction Logo" width="50px!important">
                            </a>
                        </li>
