...
<div class="col-lg-6 col-md-6 col-sm-6 au-item-categorys">
 <div class="card au-cards">
    ...
    <div class="card-block au-card-block">
      ...
      <ul class="action-card-details">
          ...
          </small><span class="pull-right"><small><?php echo e(getAuctionDaysLeft($auction->start_date,$auction->end_date)); ?> / dias restantes</small></span></p></li>
           <li><p><small title="Reserve Price">$<?php echo number_format($auction->reserve_price); ?> MXN</small><span class="pull-right"><small><?php echo e($total_bids); ?> ofertadores</small></span></p></li>
      </ul>
