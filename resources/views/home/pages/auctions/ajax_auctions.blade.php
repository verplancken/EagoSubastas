 ...
 <div class="card au-cards">
    ...
    <div class="card-block au-card-block">
      ...
      <ul class="action-card-details">
          ...
          </small><span class="pull-right"><small>{{getAuctionDaysLeft($auction->start_date,$auction->end_date)}} / dias restantes</small></span></p></li>
           <li><p><small title="Reserve Price">${!! number_format($auction->reserve_price) !!} MXN</small><span class="pull-right"><small>{{$total_bids}} ofertadores</small></span></p></li>
      </ul>
